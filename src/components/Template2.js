...
function Template2() {
  ...
  const handleInsertText = () => {
    ...
    Object.keys(placeholders).forEach((key) => {
      ...
      }else if (key === 'Select one option?') {
        if (placeholders[key] === 'Lump Sum at the End of Service') {
          ...
          editorRef.current.documentEditor.searchModule.searchResults.replaceAll("The Contractor shall receive a lump sum payment of [AMOUNT] at the end of the service period, provided all contractual obligations have been fulfilled. Payment will be made within thirty (30) days of the completion of services.");
          editorRef.current.documentEditor.searchModule.findAll("The Contractor shall be paid in regular instalments of [AMOUNT] on a [weekly/monthly] basis. Payments will be made on the [specific day] of each [week/month] for the duration of the contract.");
          editorRef.current.documentEditor.searchModule.searchResults.replaceAll("The Contractor shall receive a lump sum payment of [AMOUNT] at the end of the service period, provided all contractual obligations have been fulfilled. Payment will be made within thirty (30) days of the completion of services.");
              ...
              <div key={index} style={{ marginBottom: 15 }}>
                ...
                >
                  ...
                  >
                    ...
                    <option value="Lump Sum at the End of Service">Lump Sum at the End of Service</option>
                    <option value="Regular Installments">Regular Installments¬</option>
